...
class UsingMocksApplicationTests {
	...
	public void whenUseMockAnnotation_thenMockIsInjected() {
		...
		verify(direwolvesList).add(anyString());//verifies that something was done like add()
	...
	public void whenUseCaptorAnnotation_thenTheSame() {
	    ...
	    verify(swordsList).add(swordName.capture());//Capture to verify that a string was sent in the argument, maybe
